...
class AmplitudeToDB(GraphNode):
    ...
    tensor: types.NPArray | GraphNode | tuple[GraphNode, str] = Field(
    ...
    def get_node_type(cls):
        return "lib.librosa.analysis.AmplitudeToDB"
...
class ChromaSTFT(GraphNode):
    ...
    n_fft: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.ChromaSTFT"
...
class DBToAmplitude(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.DBToAmplitude"
...
class DBToPower(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.DBToPower"
...
class GriffinLim(GraphNode):
    ...
    magnitude_spectrogram: types.NPArray | GraphNode | tuple[GraphNode, str] = Field(
        default=types.NPArray(type="np_array", value=None, dtype="<i8", shape=(1,)),
        description="Magnitude spectrogram input for phase reconstruction.",
    )
    n_iter: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    win_length: int | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    center: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True,
        description="If True, the signal `y` is padded so that frame `D[:, t]` is centered at `y[t * hop_length]`.",
    )
    length: int | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.GriffinLim"
...
class MFCC(GraphNode):
    ...
    n_mfcc: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    fmin: int | GraphNode | tuple[GraphNode, str] = Field(
        default=0, description="The lowest frequency (in Hz)."
    )
    fmax: int | GraphNode | tuple[GraphNode, str] = Field(
        default=8000, description="The highest frequency (in Hz)."
    )

    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.MFCC"
...
class MelSpectrogram(GraphNode):
    ...
    n_mels: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.MelSpectrogram"
...
class PlotSpectrogram(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.PlotSpectrogram"
...
class PowertToDB(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.PowertToDB"
...
class STFT(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.STFT"
...
class SpectralCentroid(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.SpectralCentroid"
...
class SpectralContrast(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "lib.librosa.analysis.SpectralContrast"
